...
export class MainMenu {
    create() {
        ...
        let text = this.game.add.text(this.game.world.width - 4, 4, "Welcome back " + window.playerInfo.username, style);
    ...
    gotoSetting() {
        ...
        let text = this.game.add.text(0, 0, "Group 6, Members: Sixu Bao, Chengxu Yu, Tianchuan Yu, Guancheng Tao", style);
